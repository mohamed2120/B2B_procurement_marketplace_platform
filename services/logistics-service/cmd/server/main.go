...
func main() {
	...
	healthChecker := health.NewHealthChecker("logistics-service", db, redisClient)
	...
	// Initialize logger
	logger := observability.NewLogger("logistics-service")
	...
	r.Use(middleware.ErrorHandler(diagnosticsReporter, "logistics-service"))
