...
export default function CatalogEquipmentPage() {
  ...
  const fetchData = async () => {
    ...
    setData([
      { id: '1', name: 'Sample Equipment 1', status: 'active' },
      { id: '2', name: 'Sample Equipment 2', status: 'pending' },
    ]);
    setLoading(false);
  };
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Catalog Equipment</h1>
